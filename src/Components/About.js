            ...
            <div className="searchDiv">
                ...
                <div class="logs">
                    ...
                    <div class="log">
                        ...
                        <h3 > Build Log 07/01/2021 (Late Night) </h3>

                            <p>
                                Decided to scrap whatever Step 1 I had. Planning to move forward build the project from scratch. Started with the easier pages,
                                I think I'll start with the page with the API on it. I'm thinking of using the GIPHY API just cuz I already have a key for it 
                    ...
                    <div class="log">
                        ...
                        <h3 > Build Log 07/02/2021 (Evening) </h3>

                            <p>
                                Team Retro finished like 2 hours ago. Got the GIPHY API page working, now I just need to link it up to a Home Page. Then make
                                a Build Log Page ( Haha Ironic, now I have to retro everything I did so far. I should've done the About/ Build Log Page first)
                                Getting a little busy around here. Mom's Birthday is tomorrow so gotta prep some stuff tonight. This a challenge? Programming-wise?
                    ...
                    <div class="log">
                        ...
                        <h3 > Build Log 07/02/2021 (Late Night) </h3>
                            ...
                            <p>
                                ...
                                Home Page, but they're not linking up. Getting an Error: Invariant failed: You should not use Link outside a Router. I need to review my 
                                frontend stuff again. Pretty big weakness right here, taking not of it since TTP Bootcamp. I'm pretty bad a linking stuff up, with pathing
                    ...
                    <div class="log">
                        ...
                        <h3 > Build Log 07/03/2021 (Late Night) </h3>

                            <p>
                                Retro-ing today, totally got nothing done other than linking up the pages. Turns out I wasn't doing my imports AND pathing correctly. 
                    ...
                    <div class="log">
                        ...
                        <h3 > Build Log 07/04/2021 (Afternoon) </h3>
                    ...
                    <div class="log">
                        ...
                        <h3 > Build Log 07/04/2021 (Evening) </h3>

                            <p>
                                Put it up on GitHub. I need to add Cam to my repo, but idk how lol. I'll get to it like 30 mins before the standup on Tuesday or something.
                                I honestly don't know how to add someone as a collaborator, I'll have to look it up. So, it's all dandy rn. I'm adding more Build Log
                    ...
                    <div class="log">
                        ...
                        <h3 > Build Log 07/05/2021 (Evening) </h3>
